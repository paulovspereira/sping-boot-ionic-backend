package com.pv.cursomc.resources.exception;
...
import com.pv.cursomc.service.exception.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandarError> dataIntegrity(DataIntegrityExcepetion e, HttpServletRequest request){
	...
	public ResponseEntity<StandarError> file(AuthorizationException e, HttpServletRequest request){
